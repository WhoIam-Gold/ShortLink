...
* Info: http://irbis-school.com/blog/full/11  
* @author IRBIS-school.com
* @copyright � 2013
* @version 0.1 
...
class DB
{
    ...
    { // @TODO Change the data connection
        ...
        @self::$link = mysqli_connect('localhost', 'cwqkudzo_test', 'Goldenstar00unedap', 'cwqkudzo_mag')  // for gsi.s-host

        // @self::$link = mysqli_connect('localhost', 'admin_snolly', 'm-7!x~54vUM4bJ&E6', 'admin_admin_sirius') 
